 ...
 return (
  <div
   className={clsx(
    ...
    variant === 'normal' && 'bg-white text-olive-600 inset-ring-black/10',
  ...
  >
   ...
   <button
    ...
    commandfor="snippet"
    type="button"
    className="group relative flex size-9 items-center justify-center rounded-full after:absolute after:-inset-1 hover:bg-olive-950/10 after:pointer-fine:hidden"
   >
