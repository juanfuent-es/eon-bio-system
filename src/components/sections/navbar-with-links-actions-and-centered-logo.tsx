    ...
    <header className={clsx('sticky top-0 z-50 w-full', className)} {...props}>
      <nav className="px-4">
        ...
        <ElDialog className="lg:hidden">
          <dialog id="mobile-menu" className="relative overflow-hidden backdrop:bg-transparent">
            <ElDialogPanel className="fixed inset-0 z-0 h-dvh overflow-hidden bg-green-100 px-6 py-6 lg:px-10">
              <Image
                src="/symbol.svg"
                alt="EON - Ouroboros Infinito"
                width="100"
                height="50"
                className="absolute top-0 right-0 -z-10 h-auto w-4xl max-w-none translate-x-1/2 -translate-y-1/3 -scale-x-100 rotate-180 opacity-5"
              />
              <Image
                src="/symbol.svg"
                alt="EON - Ouroboros Infinito"
                width="100"
                height="50"
                className="absolute right-0 bottom-0 -z-10 h-auto w-4xl max-w-none translate-x-1/12 translate-y-1/3 scale-x-100 -scale-y-100 opacity-5"
              />
              <div className="flex min-h-full flex-col">
                <div className="flex shrink-0 justify-between">
                  <Link
                    href="/"
                    className={clsx(
                      'decoration-none inline-flex items-center transition-colors duration-300',
                ...
                <div
                  className="flex flex-1 flex-col justify-evenly gap-5 py-3 landscape:gap-3 landscape:py-2"
                  id="menu-sections-container"
                >
                  {leftLinks}
                  {rightLinks}
                  {!isApplyPage ? (
                ...
                <div className="flex shrink-0 flex-col items-start justify-center gap-4">
                  <section className="w-full">
                    <nav className="flex w-full items-center justify-between gap-4 text-sm text-green-950/90">
                  ...
                  <section className="w-full border-t border-green-900/10 pt-4">
                    <div className="text-md flex flex-col gap-3 text-green-900/90">
                      <a
                        href="mailto:contacto@eonbiosystem.com"
                      ...
                      <a
                        href="https://wa.me/5215545848965"
                        className="inline-flex items-center gap-2 hover:text-orange-600"
                      >
