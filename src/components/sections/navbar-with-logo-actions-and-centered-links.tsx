...
export function NavbarWithLogoActionsAndCenteredLinks({
 ...
 return (
  <header className={clsx('sticky top-0 z-10 bg-green-1000', className)} {...props}>
    ...
    <div className="mx-auto flex h-(--scroll-padding-top) max-w-7xl items-center gap-4 px-6 lg:px-10">
     ...
     <div className="flex flex-1 items-center justify-end gap-4">
      ...
      <button
       ...
       className="inline-flex rounded-full p-1.5 text-green-950 hover:bg-green-950/10 lg:hidden"
      >
      ...
      <ElDialogPanel className="fixed inset-0 bg-green-100 px-6 py-6 lg:px-10">
       <div className="flex justify-end">
        <button
         ...
         commandfor="mobile-menu"
         aria-label="Toggle menu"
         className="inline-flex rounded-full p-1.5 text-green-950 hover:bg-green-950/10"
        >
         <svg
