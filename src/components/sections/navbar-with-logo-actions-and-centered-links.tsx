...
export function NavbarLink({
 ...
 return (
  <Link
   href={href}
   className={clsx(
    'group inline-flex items-center justify-between gap-2 text-3xl/10 font-medium text-olive-950 lg:text-sm/7',
    className,
   )}
   {...props}
  >
...
export function NavbarWithLogoActionsAndCenteredLinks({
 ...
 return (
  <header className={clsx('sticky top-0 z-10 bg-olive-100 className)} {...props}>
   ...
   <nav>
    ...
    <ElDialog className="lg:hidden">
     <dialog id="mobile-menu" className="backdrop:bg-transparent">
      <ElDialogPanel className="fixed inset-0 bg-olive-100 px-6 py-6 lg:px-10">
       <div className="flex justify-end">
        <button
         command="close"
         commandfor="mobile-menu"
         aria-label="Toggle menu"
         className="inline-flex rounded-full p-1.5 text-olive-950 hover:bg-olive-950/10"
        >
         <svg
