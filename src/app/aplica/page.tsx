  ...
  return (
    <>
      ...
      <section id="form" className="py-16 sm:py-24">
        <Container className="max-w-2xl">
          ...
          <form className="flex flex-col gap-8">
            {/* Datos básicos */}
            <fieldset className="flex flex-col gap-6 border-t border-mineral-200 pt-8 dark:border-mineral-800">
              <legend className="text-lg font-display font-bold text-obsidian-900 dark:text-bone-100">
                Datos básicos
              </legend>

              <div>
                <label htmlFor="name" className="block text-sm font-semibold text-obsidian-900 dark:text-bone-100">
                ...
                <input
                  ...
                  name="name"
                  required
                  className="mt-2 w-full rounded-lg border border-mineral-300 bg-bone-50 px-4 py-3 text-obsidian-900 placeholder-mineral-500 focus:border-vital-500 focus:outline-none focus:ring-2 focus:ring-vital-100 dark:border-mineral-700 dark:bg-obsidian-900 dark:text-bone-50 dark:placeholder-mineral-400 dark:focus:ring-vital-900"
                  placeholder="Tu nombre completo"
                />
              </div>

              <div>
                <label htmlFor="email" className="block text-sm font-semibold text-obsidian-900 dark:text-bone-100">
              ...
              <div>
                <label
                  htmlFor="phone"
                  className="block text-sm font-semibold text-obsidian-900 dark:text-bone-100"
                >
              ...
              <div>
                <label htmlFor="age" className="block text-sm font-semibold text-obsidian-900 dark:text-bone-100">
                  Edad
                </label>
                <input
                  type="number"
            ...
            <fieldset className="flex flex-col gap-6 border-t border-mineral-200 pt-8 dark:border-mineral-800">
              ...
              <div className="flex flex-col gap-4">
                <label className="block text-sm font-semibold text-obsidian-900 dark:text-bone-100">
                ...
                <div className="flex flex-col gap-3">
                  {[
                    ...
                    <label key={option.value} className="flex items-center gap-3 cursor-pointer">
                      ...
                      />
                      <span className="text-sm text-obsidian-700 dark:text-bone-200">{option.label}</span>
                    </label>
                  ))}
                </div>
              </div>
            ...
            {/* Consentimiento */}
            <fieldset className="flex flex-col gap-4 border-t border-mineral-200 pt-8 dark:border-mineral-800">
              <label className="flex items-start gap-3 cursor-pointer">
                ...
                />
                <span className="text-sm text-obsidian-700 dark:text-bone-200">
            ...
            {/* Botón de envío */}
            <div className="flex gap-4 border-t border-mineral-200 pt-8 dark:border-mineral-800">
      ...
      <FooterWithNewsletterFormCategoriesAndSocialIcons
        ...
        cta={
          <NewsletterForm
            headline={<span className="text-lg font-display font-bold text-obsidian-900 dark:text-bone-50">EON Bio</span>}
