        ...
        <html lang="es" className="bg-neutral-200 text-neutral-50">
            ...
            <body className="w-full overflow-x-hidden">
                    ...
                    <NavbarWithLinksActionsAndCenteredLogo
                        ...
                        logo={
                            <NavbarLogo href="/">
                                <svg id="eon-logo" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 100 60" fill="currentColor" width="30" height="18" className="w-20 h-auto transition-colors duration-300 text-green-800">
                        ...
                        cta={
                            <div className="flex flex-col gap-6 text-green-700">
                                <div>
                                    ...
                                    <address className="not-italic text-sm/7">
                                        <a href="https://maps.app.goo.gl/7HCJZv8jL7gShTRs9" target="_blank" title='Ver Ubicación en GoogleMaps' className="md:hover:text-orange-600 transition-colors">
